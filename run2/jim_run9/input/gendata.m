...
H = zeros(240, 400);
% h = readbin('H_new.box', [60 100], 1, 'real*8');
h = rdmds('/home/toshiki/MITgcm/run2/jim_run9/input/surfDiag.0018921600');
h = h(2:59,2:60, 6);
...
fid = fopen('H_new1.box','r','b'); H_streamice = fread(fid,[nx ny],'real*8'); fclose(fid);
